...
//			    echo("Success! Transaction ID: " . $result->transaction->id);
		...
		if ( $result->transaction ) {
		    $errMessage = sprintf( __( '%s payment declined.<br />Error: %s<br />Code: %s', 'woocommerce' ), $this->title, $result->message . ( ! empty( $result->transaction->additionalProcessorResponse ) ? '<br />' . $result->transaction->additionalProcessorResponse : ''), $result->transaction->processorResponseCode );
